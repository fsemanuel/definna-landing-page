          ...
          <div className="space-y-8">
            ...
            <Card variant="glass" className="p-8">
              <CardHeader className="p-0 mb-6">
                <CardTitle className="flex items-center space-x-2 text-2xl">
                  <Globe className="h-6 w-6 text-brand-500" />
                  <span>7. Transferências Internacionais</span>
                </CardTitle>
              </CardHeader>
              <CardContent className="p-0 space-y-4 text-muted-foreground">
                <p>
                  Alguns de nossos provedores de serviços estão localizados fora do Brasil. 
                  Quando transferimos dados para outros países:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  <li>Garantimos que os países têm nível adequado de proteção de dados</li>
                  <li>Implementamos salvaguardas contratuais apropriadas</li>
                  <li>Utilizamos cláusulas contratuais padrão quando necessário</li>
                  <li>Obtemos seu consentimento quando exigido por lei</li>
                </ul>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-0 space-y-4 text-muted-foreground">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-muted/20 rounded-lg p-4">
                    <h4 className="text-foreground font-semibold mb-2 text-sm">Períodos Típicos</h4>
                    <ul className="text-xs space-y-1">
                      <li>• Dados de conta: Enquanto ativa + 3 anos</li>
                      <li>• Dados de conversação: 2 anos</li>
